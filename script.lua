...
zomTab:Section("SPECIAL TECHNIQUE")
	zomTab:InfoLabel("DOMAIN EXPANSION...")
zomTab:Button("anti escape", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/Coolestsmug/Coolestsmug/main/unescapeablehuman.lua"))()
end)

zomTab:Button("anti zombiecamp", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/Coolestsmug/Coolestsmug/main/antispawncamp(zombie).lua"))()
end)
