loadstring(game:HttpGet("https://pastebin.com/raw/njPmqnJQ"))()
	local Window = UiLib:CreateWindow("Chaos but you made it turn into ultra chaos")
	local Page1 = Window:CreatePage("Weapons")
	local Page2 = Window:CreatePage("Teleports")
	local Page3 = Window:CreatePage("Local Player")
	local Themes = Window:CreatePage("Themes")
	local Credits =	Window:CreatePage("Credits")
	...
	Credits:NewTextFrame("N0ne#3101 | Fast gun and spam grade, fast gun")
	...
	Page1:NewToggle("Get weapons when respawn", function(a)
		On2 = a
	end)

	Page1:NewToggle("Fast shoot", function(a)
		On3 = a
	end)

	Page1:NewToggle("Dupe Items", function(a)
		On4 = a
	end)

	Page1:NewToggle("Spam Grenade", function(a)
		On5 = a
	end)

	Page1:NewToggle("Spam Spike", function(a)
		On6 = a
	end)

	Page1:NewToggle("Spam C4", function(a)
		On7 = a
	end)

	Page1:NewToggle("Kill all", function(a)
		On8 = a
	end)

	Page1:NewToggle("Kill aura", function(a)
		On8 = a
	end)

	Page1:NewButton("Emerald Sword", function()
	...
	Page1:NewButton("Blood Dagger", function()
		if game.Players.LocalPlayer.Character:FindFirstChild("Loaded") then
			game.Players.LocalPlayer.Character.Loaded:Destroy()
		end
		game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild("Menu Screen").Enabled = false
